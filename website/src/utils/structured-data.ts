    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Yes — currently open to freelance, contract, part-time, and full-time opportunities. Based in ${CONTACT_INFO.location}, ${CONTACT_INFO.country}, available for remote work internationally. Specializes in embedded systems, backend services, and spec-driven development with AI-assisted workflows.`,
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Specializes in embedded systems, spec-driven development, and AI-assisted workflows. Expert in C/C++, Python, JavaScript/TypeScript, Elixir, embedded systems (ESP32, FreeRTOS, BLE), and cloud technologies (AWS, Docker).',
        },
      },
      {
        '@type': 'Question',
