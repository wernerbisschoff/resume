...
- ✅ **Frontend Design Plugin** - Claude Code's `frontend-design` skill for rapid, production-quality UI component development with distinctive aesthetics.
...
**For rapid UI component development**, use Claude Code's `frontend-design` skill:

- Invoke with: `/frontend-design` or ask Claude to "build [component] with the frontend-design plugin"
- Generates production-quality, distinctive UI components
- Avoids generic AI aesthetics with unique design patterns
- Ideal for custom widgets, landing pages, and interactive interfaces
